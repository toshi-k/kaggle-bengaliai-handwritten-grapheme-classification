...
def bbox(img):
    """ Iafoss / Image preprocessing (128x128)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--dir_dataset',
        default=Path('../../dataset'),  # local
        # default=Path('/kaggle/input/bengaliai-cv19'),  # kaggle
        type=Path
    )

    parser.add_argument(
        '--dir_model',
        default=Path('_model'),  # local
        # default=Path('/kaggle/input/bengali-nn-5models'),  # kaggle
        type=Path
    )
